...
print("")
print("You will receive the results of your new number in this order: Addition, subtraction, multiplication, and division.")
...
print("Here's a list of Boeing Jets sorted out by ascending numbers (7X7) with the original string and tuple of them:")
print(num_list)
print(str(num_tuple))
print("")
